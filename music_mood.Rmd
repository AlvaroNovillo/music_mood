...
music_data <- subset(music_data, select = c("name","artist", "album","id", "popularity", "danceability", "acousticness", "energy", "instrumentalness", "liveness", "valence", "loudness", "speechiness", "tempo","mood"))
...
h + scale_fill_manual(values=coul)
```
```{r}
...
```{r}
numeric_data <- subset(data, select = c( "popularity", "danceability", "acousticness", "energy", "instrumentalness", "liveness", "valence", "loudness", "speechiness", "tempo","mood"))
